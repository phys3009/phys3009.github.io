  ...
  <div class="highlight">
    <pre>
      <div class=flex-center>
        ...
        <button class="styled-button" onclick="window.open('https://www.nottingham.ac.uk/~ppzmis/phys3009/ppt/Lecture5.pdf', '_blank')">Download<br>Slides</button>
      </div>
...
<div style="text-align: center;">
    <img src="imgs/5_6.png" alt="Hamaker Constants" width="400" height=auto>
    <p><em>Figure 5.6 - Table of Hamaker constants for common materials (Taken from Surface and Intermolecular forces by J. Israelachvili $3^{rd}$ edition.)</em></p>
</div>
