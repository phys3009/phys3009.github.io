...
3.  The number of headgroups per unit area is $\frac{2}{a_0}$. One on outer edge,
    one inner edge so the energy per unit area is $\frac{k{\Delta}a^{2}^{2}}{2a_{0}}$. Substituting Δa gives:

$$\frac{\mathrm{\Delta}U}{A}\  \approx \ \frac{\kappa}{2R^{2}}$$

where $\kappa = \ \frac{kl_{c}^{2}a_{0}}{2}$.
...
<div style="text-align: center;">
    <img src="imgs/15_5.png" alt="moduli" width="250" height=auto>
