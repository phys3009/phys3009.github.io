  ...
  <div class="highlight">
    <pre>
      <div class=flex-center>
        ...
        <button class="styled-button" onclick="window.open('ppt_pdfs/Lecture6.pdf', '_blank')">Download<br>Slides</button>
...
these bonds break apart. If the temperature drops below $T=0^{\circ}C$ thermal
fluctuations struggle to overcome the strength of the bond, hence water freezes. As the
Temperature climbs to $T=100^{\circ}C$ thermal fluctuations have an increasing
...
<div style="text-align: center;">
    <img src="imgs/6_6.png" alt="proteins" width="400" height=auto>
...
_The hydrophobic effect is a difficult subject as it logically fits with
...
However, a more detailed explanation of this aspect is included later._
...
There is still no satisfactory theory to explain the details of the hydrophobic interaction. This is because the interaction between two surfaces involves many layers of intervening molecules. Measurements show that the interaction energy, _U,_ decays exponentially with the separation between surfaces
