const replacements = {
    ...
    'EXAMKIT' : 'https://www.nottingham.ac.uk/currentstudents/documents/healthyu/2021-documents/web-640597-scom-a5-20pp-examtoolkit-update-njt-feb22.pdf',
    'YELLOWBOOK' : "https://www.rethinkyourmind.co.uk/The-UoN-Physics-and-Astronomy-Yellow-Book-Online/?page=1"
  };
  
  function replaceValues() {
    for (const [placeholder, replacement] of Object.entries(replacements)) {
      document.body.innerHTML = document.body.innerHTML.replace(new RegExp(placeholder, 'g'), replacement);
    }
  }
